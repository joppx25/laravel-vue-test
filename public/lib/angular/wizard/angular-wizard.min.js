...
angular.module("wizard.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("wizard.html",
        ...
        "      <li ng-class=\"{default: !step.completed && !step.selected, current: step.selected && !step.completed, done: step.completed && !step.selected, editing: step.selected && step.completed}\" ng-repeat=\"step in getEnabledSteps() track by $index\">\n" +
        "        <a ng-click=\"goTo(step)\"><div class=\"ctr\">{{$index + 1}}</div>{{step.title || step.wzTitle}}</a>\n" +
        "      </li>\n" +
        "    </ul>\n" +
